...
export function isCorrect(question: Question, answer: string): boolean {
    const answer2: string = answer.toLowerCase();
    const answer3: string = answer2.trim();
    const correctAnswer: string = question.expected.toLowerCase();
    return answer3 === correctAnswer;
}
